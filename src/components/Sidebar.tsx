...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-56 bg-white border-r border-slate-200/90 flex flex-col justify-between shrink-0 select-none shadow-xs">
      ...
      {/* Operations Engine Widget Footer */}
      <div className="p-3.5 m-2.5 rounded-2xl bg-gradient-to-br from-indigo-50/90 via-slate-50 to-white text-slate-900 border border-indigo-200/70 shadow-2xs relative overflow-hidden space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-extrabold text-indigo-950">Operations Engine</span>
        </div>
        <p className="text-[11px] text-slate-600 leading-snug font-medium">
          Automated analyzer evaluating sprint velocity, risks, and capacity limits.
        </p>
        <button
